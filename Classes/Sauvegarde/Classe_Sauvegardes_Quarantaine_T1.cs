...
{
    static class Classe_Sauvegardes_Quarantaine_T1
    {
        ...
        static private string _fichier_Map_Quarantaine = "Map.csv";
        static private string _fichier_Codex_Quarantaine = "Codex.csv";
        static private string _fichier_Players_Attaquant_Quarantaine = "Players_Attaquant.csv";
        static private string _fichier_Players_Defenseur_Quarantaine = "Players_Defenseur.csv";
        static private string _fichier_Scores_Attaquant_Quarantaine = "Scores_Attaquant.csv";
        static private string _fichier_Scores_Defenseur_Quarantaine = "Scores_Defenseur.csv";
        static private string _fichier_Choix_ObjS_Attaquant_Quarantaine = "Choix_ObjS_Attaquant.csv";
        static private string _fichier_Choix_ObjS_Defenseur_Quarantaine = "Choix_ObjS_Defenseur.csv";
        ...
        static private string _chemin_Map_Quarantaine = Path.Combine(_dossier_Quarantaine, _fichier_Map_Quarantaine);
        static private string _chemin_Codex_Quarantaine = Path.Combine(_dossier_Quarantaine, _fichier_Codex_Quarantaine);
        static private string _chemin_Players_Attaquant_Quarantaine = Path.Combine(_dossier_Quarantaine, _fichier_Players_Attaquant_Quarantaine);
        static private string _chemin_Players_Defenseur_Quarantaine = Path.Combine(_dossier_Quarantaine, _fichier_Players_Defenseur_Quarantaine);
        static private string _chemin_Scores_Attaquant_Quarantaine = Path.Combine(_dossier_Quarantaine, _fichier_Scores_Attaquant_Quarantaine);
        static private string _chemin_Scores_Defenseur_Quarantaine = Path.Combine(_dossier_Quarantaine, _fichier_Scores_Defenseur_Quarantaine);
        static private string _chemin_Choix_ObjS_Attaquant_Quarantaine = Path.Combine(_dossier_Quarantaine, _fichier_Choix_ObjS_Attaquant_Quarantaine);
        static private string _chemin_Choix_ObjS_Defenseur_Quarantaine = Path.Combine(_dossier_Quarantaine, _fichier_Choix_ObjS_Defenseur_Quarantaine);
        ...
        public static void Sauvegarder_Pages_CSV(int Pages)
        {
            ...
            StringBuilder ligne = new StringBuilder();
            using (StreamWriter fichier = new StreamWriter(_chemin_Pages_Quarantaine, false, Encoding.UTF8, 1024))
            {
                ligne.Append(Pages + ";");
                fichier.WriteLine(ligne.ToString());
                ligne.Clear();
        ...
        public static void Sauvegarder_Format_CSV(int format)
        {
            ...
            StringBuilder ligne = new StringBuilder();
            using (StreamWriter fichier = new StreamWriter(_chemin_Format_Quarantaine, false, Encoding.UTF8, 1024))
            {
                ligne.Append(format + ";");
                fichier.WriteLine(ligne.ToString());
                ligne.Clear();
        ...
        public static void Sauvegarder_FormatBis_CSV(int formatBis)
        {
            ...
            StringBuilder ligne = new StringBuilder();
            using (StreamWriter fichier = new StreamWriter(_chemin_FormatBis_Quarantaine, false, Encoding.UTF8, 1024))
            {
        ...
        public static void Sauvegarder_Map_CSV(int map)
        {
            ...
            StringBuilder ligne = new StringBuilder();
            using (StreamWriter fichier = new StreamWriter(_chemin_Map_Quarantaine, false, Encoding.UTF8, 1024))
            {
                ligne.Append(map + ";");
                fichier.WriteLine(ligne.ToString());
                ligne.Clear();
        ...
        public static void Sauvegarder_Codex_CSV(bool codex)
        {
            ...
            StringBuilder ligne = new StringBuilder();
            using (StreamWriter fichier = new StreamWriter(_chemin_Codex_Quarantaine, false, Encoding.UTF8, 1024))
            {
                ligne.Append(codex + ";");
                fichier.WriteLine(ligne.ToString());
                ligne.Clear();
        ...
        public static void Sauvegarder_Players_Attaquant_CSV(String[] Players_Attaquant)
        {
            ...
            StringBuilder ligne = new StringBuilder();
            using (StreamWriter fichier = new StreamWriter(_chemin_Players_Attaquant_Quarantaine, false, Encoding.UTF8, 1024))
            {
                for (int i = 0; i < 3; i++)
                {
        ...
        public static void Sauvegarder_Players_Defenseur_CSV(String[] Players_Defenseur)
        {
            ...
            StringBuilder ligne = new StringBuilder();
            using (StreamWriter fichier = new StreamWriter(_chemin_Players_Defenseur_Quarantaine, false, Encoding.UTF8, 1024))
            {
                for (int i = 0; i < 3; i++)
                {
        ...
        public static void Sauvegarder_Scores_Attaquant_CSV(int[] Scores_Attaquant)
        {
            ...
            StringBuilder ligne = new StringBuilder();
            using (StreamWriter fichier = new StreamWriter(_chemin_Scores_Attaquant_Quarantaine, false, Encoding.UTF8, 1024))
            {
                for (int i = 0; i < 3; i++)
                {
        ...
        public static void Sauvegarder_Scores_Defenseur_CSV(int[] Scores_Defenseur)
        {
            ...
            StringBuilder ligne = new StringBuilder();
            using (StreamWriter fichier = new StreamWriter(_chemin_Scores_Defenseur_Quarantaine, false, Encoding.UTF8, 1024))
            {
                for (int i = 0; i < 3; i++)
                {
        ...
        public static void Sauvegarder_Mem_Saisie_Attaquant_CSV(string[,] Mem_Saisie_Attaquant)
        {
            ...
            StringBuilder ligne = new StringBuilder();
            using (StreamWriter fichier = new StreamWriter(_chemin_Mem_Saisie_Attaquant_Quarantaine, false, Encoding.UTF8, 1024))
            {
                for (int t = 0; t < 20; t++)
                {
                    for (int i = 0; i < 100; i++)
        ...
        public static void Sauvegarder_Mem_Saisie_Defenseur_CSV(string[,] Mem_Saisie_Defenseur)
        {
            ...
            StringBuilder ligne = new StringBuilder();
            using (StreamWriter fichier = new StreamWriter(_chemin_Mem_Saisie_Defenseur_Quarantaine, false, Encoding.UTF8, 1024))
            {
                for (int t = 0; t < 20; t++)
                {
                    for (int i = 0; i < 100; i++)
